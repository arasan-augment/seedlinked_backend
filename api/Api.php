...
class API extends REST {
    ...
    public $user = "root";
    public $pass = "";
    public $dbname = "seedlinked_backend";
    public $prefix = "sl_";
    public $active = "1";
    public $inactive = "2";
    ...
    public function passwordEncrypt($string) {
        ...
        $encrypted = base64_encode(
                $iv .
                mcrypt_encrypt(
                        MCRYPT_RIJNDAEL_128, hash('sha256', $this->passKey, true), $string, MCRYPT_MODE_CBC, $iv
                )
        );
        return $encrypted;
    }
    ...
    public function passwordDecrypt($encryptString) {
        ...
        $decrypted = rtrim(
                mcrypt_decrypt(
                        MCRYPT_RIJNDAEL_128, hash('sha256', $this->passKey, true), substr($data, mcrypt_get_iv_size(MCRYPT_RIJNDAEL_128, MCRYPT_MODE_CBC)), MCRYPT_MODE_CBC, $iv
                ), "\0"
        );
        return $decrypted;
    }
